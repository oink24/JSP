...
<body>
    <div id="container">
        ...
        <div id="sub"> <!-- main -->
            <div class="bg"><img src="../images/sub_top_tit5.png" alt="COMMUNITY"></div>
            <section class="community">
                <aside>
                    <img src="../images/sub_aside_cate5_tit.png" alt="1:1고객문의">
                    <ol class="lnb">
                        <li><a href="#">1:1고객문의</a></li>
                        <li><a href="#">오늘의식단</a></li>
                        <li><a href="#">나도요리사</a></li>
                        <li class="on"><a href="#">1:1고객문의</a></li>
