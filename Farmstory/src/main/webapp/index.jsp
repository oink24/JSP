    ...
    <div id="container">
        <header>
            ...
            <ul class="gnb">
                ...
                <li><a href="#">장보기<img src="./images/head_menu_badge.png"></a></li>
        ...
        <main>
            <div class="slider">
                <ul class="slides">
                    <li><img src="./images/main_slide_img1.jpg" alt="slide1"></li>
                    <li><img src="./images/main_slide_img2.jpg" alt="slide2"></li>
                    <li><img src="./images/main_slide_img3.jpg" alt="slide3"></li>
                </ul>
                ...
                <div class="banner">
                    ...
                    <img src="./images/main_banner_img.png" alt="배너 이미지">
                </div>
            </div>
            <div class="quick">
            ...
            <div class="latest">
                ...
                <article>
                    <a href="#"><img src="./images/main_latest3_tit.png" alt="농작물이야기"></a>
