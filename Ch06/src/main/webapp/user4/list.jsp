...
<html>
	...
	<body>
		...
		<input type="button" value="User4 등록" onclick="location.href='/Ch06/user4/register.jsp'">
		...
		<table border="1">
			...
			<tr>
				...
				<td>
					...
					<input type="button" value="수정" onclick="location.href='/Ch06/user4/modify.jsp?seq=<%= vo.getSeq() %>'">
					<input type="button" value="삭제" onclick="location.href='/Ch06/user4/delete.jsp?seq=<%= vo.getSeq() %>'">
				</td>
			</tr>
			<% } %>
		</table>
